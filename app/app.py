...
def main() :
    ...
    if predict < 1 :
        message = "Très faible"
        couleur = "green "
        st.markdown(f""" Probabilité de risque de défaut : <b> :couleur[{predict}%] </b> """, unsafe_allow_html=True)
    elif predict < 5 :
        message = "Faible"
        couleur = "green "
        ...
        message = "Moyen"
        couleur = "Blue "
        st.markdown(f""" Probabilité de risque de défaut : <b> :blue[{predict}%] </b> """, unsafe_allow_html=True)
    elif predict < 20 :
        message = "Elevé"
        couleur = "orange "
        st.markdown(f""" Probabilité de risque de défaut : <b> :orange[{predict}%] </b> """, unsafe_allow_html=True)
    elif predict >= 20 :
        message = "Très élevé"
        couleur = "rouge"
